    ...
    <div className="flex min-h-screen flex-col items-center bg-prompt-black p-4">
      ...
      {winner && (
        <div className="mb-8 w-full max-w-lg">
          <div className="relative overflow-hidden rounded-xl border-4 border-prompt-green bg-gradient-to-b from-prompt-green/20 to-transparent p-6">
            ...
            <div className="relative text-center">
              ...
              <div className="mb-2 text-xs font-bold uppercase tracking-widest text-prompt-green">
                {getTitle(1)}
              </div>
              <div className="mb-4 text-3xl font-bold text-white md:text-4xl">
                {winner.playerName}
                {winner.playerId === currentPlayerId && (
                  <span className="ml-2 text-lg text-prompt-purple">(YOU!)</span>
                )}
              </div>
              <div className="text-2xl font-bold text-prompt-green">
      ...
      <div className="mb-8 w-full max-w-md">
        <div className="mb-3 text-center text-xs font-bold uppercase tracking-widest text-prompt-pink">
          THE REST OF YOU
        </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">{getTitle(entry.rank)}</div>
                </div>
              </div>
              <div className="text-right">
                <div className="font-mono text-lg font-bold text-prompt-green">
        ...
        {isHost ? (
          <>
            ...
            <button
              ...
              className="w-full rounded-lg border-2 border-gray-600 bg-transparent px-6 py-3 font-semibold text-gray-400 transition-all hover:border-gray-500 hover:text-gray-300"
            >
              Return to Home
            </button>
          </>
